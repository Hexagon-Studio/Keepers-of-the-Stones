...
public class DestructionSphereEntity extends AbstractArrow implements ItemSupplier {
	public DestructionSphereEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		super(PowerModEntities.DESTRUCTION_SPHERE, world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(PowerModItems.DESTRUCTION_SPHERE);
	}
	...
	public void onHitBlock(BlockHitResult blockHitResult) {
		...
		DestructionPowerUseProcedure.execute(world, x, y, z);
	}
	...
	public static DestructionSphereEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		DestructionSphereEntity entityarrow = new DestructionSphereEntity(PowerModEntities.DESTRUCTION_SPHERE, entity, world);
	...
	public static DestructionSphereEntity shoot(LivingEntity entity, LivingEntity target) {
		DestructionSphereEntity entityarrow = new DestructionSphereEntity(PowerModEntities.DESTRUCTION_SPHERE, entity, entity.level);
