...
public class WaterFlowEntity extends AbstractArrow implements ItemSupplier {
	public WaterFlowEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		super(PowerModEntities.WATER_FLOW, world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(PowerModItems.WATER_FLOW);
	}
	...
	public void onHitBlock(BlockHitResult blockHitResult) {
		...
		WaterCreateOnBlockProcedure.execute(world, x, y, z);
	}
	...
	public static WaterFlowEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		WaterFlowEntity entityarrow = new WaterFlowEntity(PowerModEntities.WATER_FLOW, entity, world);
	...
	public static WaterFlowEntity shoot(LivingEntity entity, LivingEntity target) {
		WaterFlowEntity entityarrow = new WaterFlowEntity(PowerModEntities.WATER_FLOW, entity, entity.level);
