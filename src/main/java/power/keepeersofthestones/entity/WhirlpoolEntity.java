...
public class WhirlpoolEntity extends AbstractArrow implements ItemSupplier {
	...
	public ItemStack getItem() {
		return new ItemStack(PowerModItems.WHIRLPOOL);
	}
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		WhirlpoolpowerProcedure.execute(entity);
	}
	...
	public static WhirlpoolEntity shoot(LivingEntity entity, LivingEntity target) {
		WhirlpoolEntity entityarrow = new WhirlpoolEntity(PowerModEntities.WHIRLPOOL, entity, entity.level);
