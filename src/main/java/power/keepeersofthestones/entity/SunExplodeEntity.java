...
public class SunExplodeEntity extends AbstractArrow implements ItemSupplier {
	...
	public ItemStack getItem() {
		return new ItemStack(PowerModItems.SUN_EXPLODE);
	}
	...
	public void onHitBlock(BlockHitResult blockHitResult) {
		...
		SunExplodeUseProcedure.execute(world, x, y, z);
	}
	...
	public static SunExplodeEntity shoot(LivingEntity entity, LivingEntity target) {
		SunExplodeEntity entityarrow = new SunExplodeEntity(PowerModEntities.SUN_EXPLODE, entity, entity.level);
