...
public class AirFlowEntity extends AbstractArrow implements ItemSupplier {
	...
	public AirFlowEntity(EntityType<? extends AirFlowEntity> type, Level world) {
		super(type, world);
	}

	public AirFlowEntity(EntityType<? extends AirFlowEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public AirFlowEntity(EntityType<? extends AirFlowEntity> type, LivingEntity entity, Level world) {
	...
	public static AirFlowEntity shoot(LivingEntity entity, LivingEntity target) {
		AirFlowEntity entityarrow = new AirFlowEntity(PowerModEntities.AIR_FLOW, entity, entity.level);
