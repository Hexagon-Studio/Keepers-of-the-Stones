...
public class MoonStonesEntity extends AbstractArrow implements ItemSupplier {
	public MoonStonesEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		super(PowerModEntities.MOON_STONES, world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(PowerModItems.MOON_STONES);
	}
	...
	public void onHitBlock(BlockHitResult blockHitResult) {
		...
		SetBlockMoonStoneProcedure.execute(world, x, y, z);
	}
	...
	public static MoonStonesEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		MoonStonesEntity entityarrow = new MoonStonesEntity(PowerModEntities.MOON_STONES, entity, world);
	...
	public static MoonStonesEntity shoot(LivingEntity entity, LivingEntity target) {
		MoonStonesEntity entityarrow = new MoonStonesEntity(PowerModEntities.MOON_STONES, entity, entity.level);
