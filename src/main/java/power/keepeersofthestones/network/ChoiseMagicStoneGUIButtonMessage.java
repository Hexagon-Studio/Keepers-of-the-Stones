...
@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD) public class ChoiseMagicStoneGUIButtonMessage {
...
;
	...
	@SubscribeEvent public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(ChoiseMagicStoneGUIButtonMessage.class, ChoiseMagicStoneGUIButtonMessage::buffer, ChoiseMagicStoneGUIButtonMessage::new, ChoiseMagicStoneGUIButtonMessage::handler);
	}
