...
public class EBTechnologyScreen extends AbstractContainerScreen<EBTechnologyMenu> {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/technology_stone.png"));
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/technology_element.png"));
