...
public class EBDestructionScreen extends AbstractContainerScreen<EBDestructionMenu> {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/destruction_stone.png"));
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/destruction_element.png"));
