...
public class CheckPointTPScreen extends AbstractContainerScreen<CheckPointTPMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("power:textures/check_point_tp.png" );
	...
	@Override public void init() {
		...
		this.minecraft.keyboardHandler.setSendRepeatsToGui(true);
				...
				this.addRenderableWidget(new Button(this.leftPos + 24, this.topPos + 106,
