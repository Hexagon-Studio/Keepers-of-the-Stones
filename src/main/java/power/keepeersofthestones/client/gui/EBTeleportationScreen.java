...
public class EBTeleportationScreen extends AbstractContainerScreen<EBTeleportationMenu> {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/teleportation_stone.png"));
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/teleportation_element.png"));
