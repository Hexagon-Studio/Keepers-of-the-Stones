...
public class BuyLevel3Screen extends AbstractContainerScreen<BuyLevel3Menu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("power:textures/buy_level_3.png" );
	...
	@Override protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		    	this.font.draw(poseStack, "To buy, put the required number of coins in the slot (16)",
					46, 7, -12829636);
	}
