...
public class EBLightningScreen extends AbstractContainerScreen<EBLightningMenu> {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/lightning_stone.png"));
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/lightning_element.png"));
