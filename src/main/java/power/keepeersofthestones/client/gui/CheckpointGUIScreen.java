...
public class CheckpointGUIScreen extends AbstractContainerScreen<CheckpointGUIMenu> {
	...
	@Override protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		    	this.font.draw(poseStack, "Returning to the last point",
					15, 7, -12829636);
		    	this.font.draw(poseStack, "Time travel",
					60, 79, -12829636);
	}
	...
	@Override public void init() {
		...
		this.minecraft.keyboardHandler.setSendRepeatsToGui(true);
				...
				this.addRenderableWidget(new Button(this.leftPos + 24, this.topPos + 25,
					126, 20, new TextComponent("Checkpoint"), e -> {
							if (        true
) {
				...
				this.addRenderableWidget(new Button(this.leftPos + 24, this.topPos + 52,
					126, 20, new TextComponent("Set checkpoint"), e -> {
							if (        true
) {
				...
				this.addRenderableWidget(new Button(this.leftPos + 24, this.topPos + 97,
					126, 20, new TextComponent("Return to the past"), e -> {
							if (        true
) {
				...
				this.addRenderableWidget(new Button(this.leftPos + 24, this.topPos + 124,
					134, 20, new TextComponent("Return to the present"), e -> {
							if (        true
) {
