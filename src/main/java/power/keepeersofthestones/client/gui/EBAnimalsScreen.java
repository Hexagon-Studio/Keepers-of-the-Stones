...
public class EBAnimalsScreen extends AbstractContainerScreen<EBAnimalsMenu> {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/animals_stone.png"));
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/animals_element.png"));
