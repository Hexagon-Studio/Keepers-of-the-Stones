...
public class CultivationGUIScreen extends AbstractContainerScreen<CultivationGUIMenu> {
	...
	@Override protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		    	this.font.draw(poseStack, "Select a plant to get",
					124, 6, -12829636);
	}
	...
	@Override public void init() {
		...
		this.minecraft.keyboardHandler.setSendRepeatsToGui(true);
				...
				this.addRenderableWidget(new Button(this.leftPos + 250, this.topPos + 52,
					77, 20, new TextComponent("Water lily"), e -> {
							if (        true
) {
				...
				this.addRenderableWidget(new Button(this.leftPos + 7, this.topPos + 25,
					77, 20, new TextComponent("Oak Sapling"), e -> {
							if (        true
) {
				...
				this.addRenderableWidget(new Button(this.leftPos + 169, this.topPos + 52,
					77, 20, new TextComponent("Vine"), e -> {
							if (        true
) {
				...
				this.addRenderableWidget(new Button(this.leftPos + 88, this.topPos + 25,
					77, 20, new TextComponent("Birch Sapling"), e -> {
							if (        true
) {
				...
				this.addRenderableWidget(new Button(this.leftPos + 250, this.topPos + 25,
					77, 20, new TextComponent("Spruce Sapling"), e -> {
							if (        true
) {
				...
				this.addRenderableWidget(new Button(this.leftPos + 169, this.topPos + 25,
					77, 20, new TextComponent("Acacia Sapling"), e -> {
							if (        true
) {
				...
				this.addRenderableWidget(new Button(this.leftPos + 7, this.topPos + 52,
					77, 20, new TextComponent("Dark sapling"), e -> {
							if (        true
) {
				...
				this.addRenderableWidget(new Button(this.leftPos + 88, this.topPos + 52,
					77, 20, new TextComponent("Jungle sapling"), e -> {
							if (        true
) {
				...
				this.addRenderableWidget(new Button(this.leftPos + 7, this.topPos + 79,
					77, 20, new TextComponent("Wheat"), e -> {
							if (        true
) {
				...
				this.addRenderableWidget(new Button(this.leftPos + 88, this.topPos + 79,
					77, 20, new TextComponent("Potato"), e -> {
							if (        true
) {
				...
				this.addRenderableWidget(new Button(this.leftPos + 169, this.topPos + 79,
					77, 20, new TextComponent("Carrot"), e -> {
							if (        true
) {
				...
				this.addRenderableWidget(new Button(this.leftPos + 250, this.topPos + 79,
					77, 20, new TextComponent("Beetroot"), e -> {
							if (        true
) {
				...
				this.addRenderableWidget(new Button(this.leftPos + 7, this.topPos + 106,
					77, 20, new TextComponent("Melon"), e -> {
							if (        true
) {
				...
				this.addRenderableWidget(new Button(this.leftPos + 88, this.topPos + 106,
					77, 20, new TextComponent("Pumpkin"), e -> {
							if (        true
) {
				...
				this.addRenderableWidget(new Button(this.leftPos + 169, this.topPos + 106,
					77, 20, new TextComponent("Sugar Cane"), e -> {
							if (        true
) {
				...
				this.addRenderableWidget(new Button(this.leftPos + 250, this.topPos + 106,
					77, 20, new TextComponent("Bamboo"), e -> {
							if (        true
) {
