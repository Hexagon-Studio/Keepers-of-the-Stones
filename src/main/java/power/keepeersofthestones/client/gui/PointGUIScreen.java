...
public class PointGUIScreen extends AbstractContainerScreen<PointGUIMenu> {
	...
	@Override protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		    	this.font.draw(poseStack, "X",
					24, 34, -12829636);
		    	this.font.draw(poseStack, "Enter the desired coordinates",
					15, 7, -12829636);
		    	this.font.draw(poseStack, "Y",
					24, 70, -12829636);
		    	this.font.draw(poseStack, "Z",
					24, 106, -12829636);
	}
	...
	@Override public void init() {
		...
		this.minecraft.keyboardHandler.setSendRepeatsToGui(true);
				...
				tpX = new EditBox(this.font, this.leftPos + 33, this.topPos + 25,
				120, 20, new TextComponent("0"))
				{
					{
						setSuggestion("0");
					}
				...
				tpY = new EditBox(this.font, this.leftPos + 33, this.topPos + 61,
				120, 20, new TextComponent("0"))
				{
					{
						setSuggestion("0");
				...
				tpZ = new EditBox(this.font, this.leftPos + 33, this.topPos + 97,
				120, 20, new TextComponent("0"))
				{
					{
						setSuggestion("0");
				...
				this.addRenderableWidget(new Button(this.leftPos + 51, this.topPos + 133,
					67, 20, new TextComponent("Teleport"), e -> {
							if (        true
) {
