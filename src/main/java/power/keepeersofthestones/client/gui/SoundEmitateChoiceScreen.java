...
public class SoundEmitateChoiceScreen extends AbstractContainerScreen<SoundEmitateChoiceMenu> {
	...
	@Override protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		    	this.font.draw(poseStack, "Select the mob for emitate sound",
					6, 7, -12829636);
	}
	...
	@Override public void init() {
		...
		this.minecraft.keyboardHandler.setSendRepeatsToGui(true);
				...
				this.addRenderableWidget(new Button(this.leftPos + 51, this.topPos + 25,
					60, 20, new TextComponent("Creeper"), e -> {
							if (        true
) {
				...
				this.addRenderableWidget(new Button(this.leftPos + 51, this.topPos + 79,
					55, 20, new TextComponent("Zombie"), e -> {
							if (        true
) {
				...
				this.addRenderableWidget(new Button(this.leftPos + 51, this.topPos + 52,
					65, 20, new TextComponent("Skeleton"), e -> {
							if (        true
) {
