...
public class PowerModMobEffects {
	...
	public static final MobEffect SPACE_MASTER = register(new SpaceMasterMobEffect());
	public static final MobEffect RECHARGE_SPACE_STONE = register(new RechargeSpaceStoneMobEffect());
	...
	public static final MobEffect RECHARGE_AMBER_STONE = register(new RechargeAmberStoneMobEffect());
	public static final MobEffect AMBER_MASTER = register(new AmberMasterMobEffect());
	public static final MobEffect FOG = register(new FogMobEffect());
	public static final MobEffect RECHARGE_MAGNET_STONE = register(new RechargeMagnetStoneMobEffect());
	public static final MobEffect RECHARGE_MIST_STONE = register(new RechargeMistStoneMobEffect());
	public static final MobEffect MIST_MASTER = register(new MistMasterMobEffect());
