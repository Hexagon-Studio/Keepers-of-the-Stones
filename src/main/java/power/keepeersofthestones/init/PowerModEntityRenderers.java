...
public class PowerModEntityRenderers {
	...
	public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(PowerModEntities.TYRANNOSAURUS_REX, TyrannosaurusRexRenderer::new);
		...
		event.registerEntityRenderer(PowerModEntities.EXPLOSIVE_FLOW, ThrownItemRenderer::new);
		event.registerEntityRenderer(PowerModEntities.ICE_SPEAR, ThrownItemRenderer::new);
		event.registerEntityRenderer(PowerModEntities.GOLDEN_CROSSBOW, ThrownItemRenderer::new);
		event.registerEntityRenderer(PowerModEntities.DESTRUCTION_SPHERE, ThrownItemRenderer::new);
		event.registerEntityRenderer(PowerModEntities.AMBER_STREAKS, ThrownItemRenderer::new);
		event.registerEntityRenderer(PowerModEntities.KUNAI, ThrownItemRenderer::new);
	}
}
