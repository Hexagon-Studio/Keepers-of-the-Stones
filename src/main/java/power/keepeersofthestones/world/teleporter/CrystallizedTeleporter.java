...
public class CrystallizedTeleporter implements ITeleporter {
	...
	public static void registerPointOfInterest(RegistryEvent.Register<PoiType> event) {
		poi = new PoiType("crystallized_portal",
				Sets.newHashSet(ImmutableSet.copyOf(PowerModBlocks.CRYSTALLIZED_PORTAL.getStateDefinition().getPossibleStates())), 0, 1)
				.setRegistryName("crystallized_portal");
	...
	public Optional<BlockUtil.FoundRectangle> createPortal(BlockPos p_77667_, Direction.Axis p_77668_) {
		...
		BlockState blockstate = PowerModBlocks.CRYSTALLIZED_PORTAL.defaultBlockState().setValue(NetherPortalBlock.AXIS, p_77668_);
