...
public class DinoeraTeleporter implements ITeleporter {
	...
	public static void registerPointOfInterest(RegistryEvent.Register<PoiType> event) {
		poi = new PoiType("dinoera_portal",
				Sets.newHashSet(ImmutableSet.copyOf(PowerModBlocks.DINOERA_PORTAL.getStateDefinition().getPossibleStates())), 0, 1)
	...
	public Optional<BlockUtil.FoundRectangle> createPortal(BlockPos p_77667_, Direction.Axis p_77668_) {
		...
		BlockState blockstate = PowerModBlocks.DINOERA_PORTAL.defaultBlockState().setValue(NetherPortalBlock.AXIS, p_77668_);
