...
public class WhenPlayerWakeUpProcedure {
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		if (entity instanceof LivingEntity _entity)
			_entity.removeEffect(PowerModMobEffects.RECHARGE_SPACE_STONE);
		if (entity instanceof LivingEntity _entity)
			_entity.removeEffect(PowerModMobEffects.RECHARGE_BLOOD_STONE);
		if (entity instanceof LivingEntity _entity)
			_entity.removeEffect(PowerModMobEffects.RECHARGE_TECHNOLOGY_STONE);
		if (entity instanceof LivingEntity _entity)
			_entity.removeEffect(PowerModMobEffects.RECHARGE_TIME_STONE);
		if (entity instanceof LivingEntity _entity)
			_entity.removeEffect(PowerModMobEffects.RECHARGE_TELEPORTATION_STONE);
		if (entity instanceof LivingEntity _entity)
			_entity.removeEffect(PowerModMobEffects.RECHARGE_EXPLOSION_STONE);
		if (entity instanceof LivingEntity _entity)
			_entity.removeEffect(PowerModMobEffects.RECHARGE_AMBER_STONE);
		if (entity instanceof LivingEntity _entity)
			_entity.removeEffect(PowerModMobEffects.RECHARGE_MAGNET_STONE);
		if (entity instanceof LivingEntity _entity)
			_entity.removeEffect(PowerModMobEffects.RECHARGE_MIST_STONE);
	}
}
